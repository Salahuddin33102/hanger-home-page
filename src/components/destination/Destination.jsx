...
return (
    <div className='mx-auto max-w-[90%] mb-10  '>
        <Button text={'Popular'} customClass={'!text-start bg-white  !text-[#00AEEF] !p-0 '}/>
        ...
        <div className='flex flex-wrap  lg:flex-nowrap gap-10 mx-0 lg:gap-8 justify-start lg:justify-center mt-5'>
          {  data.map((item,i)=>{
               return(
                <div key={i} className='  md:w-[47%] '>
                    <img className='rounded-tr-[20px] rounded-tl-[20px] ' src={item.image} alt="" />
